...
namespace Parcus.Persistence.Data.Migrations
{
    ...
    [Migration("20220302233520_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parcus.Domain.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Parcus.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Parcus.Domain.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Parcus.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Parcus.Domain.Invest.PortfolioModels.BrokeragePortfolio", b =>
                {
                    ...
                    b.HasOne("Parcus.Domain.User", "User")
